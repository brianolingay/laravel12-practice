...
class RateLedgerEventsForPeriod
{
    public function __construct(private MatchPerEventPricingRules $matchPerEventPricingRules) {}
    ...
    public function execute(
        ...
        return DB::transaction(function () use ($events, $rules): int {
            ...
            $events->each(function (LedgerEvent $event) use ($rules, &$created): void {
                ...
                $matchingRules = $this->matchPerEventPricingRules->execute($event, $rules);
